...
# How to Use:
Add your Global Fishing Watch API token in `config_template.py`. You can request one [here ](https://globalfishingwatch.org/our-apis/). Make sure you have all the necessary python packages (`pip install -r requirements.txt`) and run `python main.py`

# Submission details:
See patch\_notes.md for a changelog between PA3 and PA4.
